...
const MetricCard = ({ title, value, icon: Icon, trend, trendValue }) => {
    ...
    return (
        <div className="p-6 rounded-2xl bg-[#161617]/60 backdrop-blur-xl border border-white/5 hover:border-[#2997FF]/30 transition-all duration-300 hover:-translate-y-1 group">
